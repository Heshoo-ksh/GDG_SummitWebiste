export const SpeakerSessions = [
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/47f0ffc1dfda909c97bc3f7003529ed4?s=500",
    ...
    session: {
      ...
      abstract: "Join the session to see how you can leverage Azure AI Cognitive Services with Azure Search in your apps. With the newly minted semantic search and OpenAI abilities, this technology can provide results more accurately than ever.",
      description: "We all know that providing a good search experience for website visitors is hard. Everyone expects it to “just” work like Bing or Amazon. Maybe there is a better way, maybe we fix this with a little help from some AI or even our new friend Chat GPT.\n\nJoin the session to see how you can leverage Cognitive Services with Azure Cognitive Search in your apps. With the newly minted semantic search and OpenAI abilities this technology can provide results that are semantically closer to the intent of original query.\n\nYou can expect to walk away knowing how to generate your own power search experience that leverages the power of AI to solve your search woes."
    },
  ...
  },
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/5414da7c653c4911cd0ef437fabee5fd?s=500",
    ...
    session: {
      ...
      abstract: "Blazor is a new technology from Microsoft that allows developers to write native .NET code that runs in both the server and the browser thanks to WebAssembly. If you are interested in leveraging your existing skills with .NET to build single-page applications, Blazor is the technology to learn.",
      description: "Blazor is a new technology from Microsoft that allows developers to write native .NET code that runs in both the server and the browser thanks to WebAssembly.\n\nIf you are interested in leveraging your existing skills with .NET to build single-page applications, Blazor is the technology to learn."
    },
  ...
  },
  {
    ...
    organization: '',
    session: {
      title: "Simplified App Navigation with Android Jetpack Compose Navigation",
      abstract: "Revolutionize Android app development with simplified navigation! Embrace modern best practices and make developers' lives easier. Join me and master the art of Navigation in the new Modern Android World.",
      description: "Android Jetpack Compose has revolutionized the way we build user interfaces in Android apps, and its integration with navigation components offers a modern and streamlined approach to app navigation. In this talk, Madona will explore the power and simplicity of Android Jetpack Compose Navigation.\n\nShe'll cover topics such as creating navigation graphs, handling deep linking, passing data between screens, and implementing complex navigation flows, all within the Jetpack Compose framework. Whether you’re a beginner looking to get started with Compose navigation or an experienced developer seeking best practices and advanced tips, this session will provide insights and techniques to enhance your app's navigation experience using the latest Android technologies.\n\nJoin Madona, and let's explore Modern Android Navigation with Jetpack Compose together."
    },
    tags: ["Android", "Jetpack Compose Navigation", "Modern Android Development"]
  },
  {
    id: 5,
    name: "Don Ward",
  ...
  },
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/bddd6cd4c86e2d5f1e39a7401d8aaf09?s=500",
  ...
  },
  {
    ...
    avatar: "https://papercallio-production.s3.amazonaws.com/uploads/user/avatar/12187/IMG_0275.JPG",
    ...
    session: {
      ...
      abstract: "In this talk, we will discuss the basics of generative AI and how to build your own GenAI model.",
      description: "In this talk, we will discuss the basics of generative AI and how to build your own GenAI model. We will cover the following topics:\n\n\u2022 What is generative AI?\n\u2022 How do GenAI models work?\n\u2022 The different types of GenAI models\n\u2022 How to build a GenAI model\n\u2022 How to deploy a GenAI model\n\nI will also provide hands-on examples of how to build GenAI models using open-source tools."
    },
  ...
  },
  {
    ...
    session: {
      ...
      abstract: "Close your eyes and imagine that you will use some assistive tech to code. Individuals with disabilities want to engage with your creations. How do we harness our ingenuity to build an inclusive user experience?  Join me on a journey to learn about auditing, what's broke, and how to ship for a11y.",
  ...
  },
  {
    ...
    avatar: "https://papercallio-production.s3.amazonaws.com/uploads/user/avatar/38267/Expert-GDE.png",
  ...
  },
  {
    ...
    avatar: "https://papercallio-production.s3.amazonaws.com/uploads/user/avatar/4238/headshot.jpeg",
  ...
  },
  {
    ...
    session: {
      ...
      abstract: "I didn't have a mentor or formal path to programming... I still get stuff done. Using culture to guide me. The talk is a guide for those not on the formal path.",
      description: "I didn't have a mentor or formal path to programming... I still get stuff done. It was 5 years in before I knew what modulo was... it was 10 years in before I knew what levenstien distance was... Big O notation... no clue.\n\nFoundational philosophy takes from computer culture that I found here and there. Stories and quips that are guide posts. The end of the talk goes into where the self taught can backfill some of that computer science foundation.\n\nLearning from the culture of programming humor."
    },
    tags: []
  },
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/d9c7dede97c8b27984215422b84224d8?s=500",
    ...
    session: {
      ...
      abstract: "As an advocate for decoupled architecture, many projects I have worked on leverage microservices. The separation of concerns is great, but unfortunately, has introduced issues with sharing data across the services.",
      description: "I'll be sharing my experiences with working on various projects leveraging the decoupled, microservice architecture and the many pitfalls with sharing data.\n\nI'll also share some tips and tricks to mitigate them."
    },
  ...
  },
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/ecd73462de8bcd925108807758303394?s=500",
  ...
  },
  {
    ...
    session: {
      ...
      abstract: "This presentation will cover what is flutter and the basics of building an application. Covering everything from Hello World to Widgets, Layouts, and Theming.",
      description: "This presentation will cover what is flutter and the basics of building an application. Covering everything from Hello World to Widgets, Layouts, and Theming."
    },
    tags: ["Flutter"]
  },
  {
  ...
  },
  {
    ...
    avatar: "https://secure.gravatar.com/avatar/9450dfab01d087a6e1d78bdb2a8a0ca7?s=500",
